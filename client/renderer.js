...
var COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_1 = require("../data/COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE");
...
var LIKES = sortByLikes(COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_1.COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE), ECOLOGIA = sortByTag(LIKES, "ecología"), TRANSPORTE = sortByTag(LIKES, "transporte"), INCLUSION = sortByTag(LIKES, "inclusíon"), ECONOMIA = sortByTag(LIKES, "economía"), MEDICINA = sortByTag(LIKES, "medicina");
// LIST
var app = $("#app");
//@ts-ignore
...
var getNodesFrom = function (array) {
    ...
    var nodes = array.map(function (post) {
        var post_ = post;
        var title = post_.title, description = post_.description, likes = post_.likes, source = post_.source, tags = post_.tags;
        var content = "<div><h3>" + title + "</h3></div>\n    <strong>" + likes + "<span style=\"color: Crimson;\"> \u2764</span></strong>\n     <h4>Descripci\u00F3n:</h4>\n     <p>" + description + "</p>\n     <div style=\"display: flex; flex-direction: column\">\n     <strong>Tags: <span style=\"\n     margin-bottom:5px;\n     color: #24292e;\n     padding: 2px;\n     border-radius: 30px;\n     border: 1px solid #d1d5da;\n     background-color: #f6f8fa;\n     border-radius: 6px;\n     -webkit-border-radius: 6px;\n     -moz-border-radius: 6px;\n     -ms-border-radius: 6px;\n     -o-border-radius: 6px;\">#" + (!tags || tags.length === 0 ? tags : "" + tags.join(" #")) + "</span></strong>\n     <span><strong>Fuente:</strong> <a href=\"" + source + "\">" + source + "</a></span>\n     </div>";
...
var NODES_FROM_LIKES = getNodesFrom(LIKES), NODES_FROM_ECOLOGIA = getNodesFrom(ECOLOGIA), NODES_FROM_TRANSPORTE = getNodesFrom(TRANSPORTE), NODES_FROM_INCLUSION = getNodesFrom(INCLUSION), NODES_FROM_ECONOMIA = getNodesFrom(ECONOMIA), NODES_FROM_MEDICINA = getNodesFrom(MEDICINA), NODES_FROM_COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE = getNodesFrom(COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_1.COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE);
...
getTop();
//@ts-ignore
(_b = $(".input-number")) === null || _b === void 0 ? void 0 : _b.addEventListener("change", function (e) {
    var target = e.target;
    cleanTable();
...
var count = function (selectedTag) {
    var count = 0;
    for (var _i = 0, COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_2 = COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_1.COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE; _i < COLLECTION_OF_IDEAS_FROM_HACKATHON_PAE_2.length; _i++) {
